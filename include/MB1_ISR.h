...
private:
    ...
    /**< EXTI0 */
    void EXTI0_subISR_table_init (void);
    ISRMgr_ns::status_t subISR_EXTI0_assign ( void (* subISR_p) (void) );
    ISRMgr_ns::status_t subISR_EXTI0_remove ( void (* subISR_p) (void) );
    /**< EXTI0 */

    /**< EXTI1 */
    void EXTI1_subISR_table_init (void);
    ISRMgr_ns::status_t subISR_EXTI1_assign ( void (* subISR_p) (void) );
    ISRMgr_ns::status_t subISR_EXTI1_remove ( void (* subISR_p) (void) );
    /**< EXTI1 */
};
